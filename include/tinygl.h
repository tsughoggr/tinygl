#pragma src "/sys/src/libtinygl"
#pragma lib "libtinygl.a"
...
void glVertex2f(GLfloat ,GLfloat); void glVertex2d(GLdouble ,GLdouble); void glVertex2fv(GLfloat *); void glVertex2dv(GLdouble *);
 void glVertex3f(GLfloat ,GLfloat ,GLfloat); void glVertex3d(GLdouble ,GLdouble ,GLdouble); void glVertex3fv(GLfloat *); void glVertex3dv(GLdouble *);
void glVertex4f(GLfloat ,GLfloat ,GLfloat, GLfloat ); void glVertex4d(GLdouble ,GLdouble ,GLdouble, GLdouble ); void glVertex4fv(GLfloat *); void glVertex4dv(GLdouble *);
void glColor3f(GLfloat ,GLfloat ,GLfloat); void glColor3d(GLdouble ,GLdouble ,GLdouble); void glColor3fv(GLfloat *); void glColor3dv(GLdouble *);
 void glColor4f(GLfloat ,GLfloat ,GLfloat, GLfloat ); void glColor4d(GLdouble ,GLdouble ,GLdouble, GLdouble ); void glColor4fv(GLfloat *); void glColor4dv(GLdouble *);
void glNormal3f(GLfloat ,GLfloat ,GLfloat); void glNormal3d(GLdouble ,GLdouble ,GLdouble); void glNormal3fv(GLfloat *); void glNormal3dv(GLdouble *);
void glTexCoord1f(GLfloat); void glTexCoord1d(GLdouble); void glTexCoord1fv(GLfloat *); void glTexCoord1dv(GLdouble *);
 void glTexCoord2f(GLfloat ,GLfloat); void glTexCoord2d(GLdouble ,GLdouble); void glTexCoord2fv(GLfloat *); void glTexCoord2dv(GLdouble *);
void glTexCoord3f(GLfloat ,GLfloat ,GLfloat); void glTexCoord3d(GLdouble ,GLdouble ,GLdouble); void glTexCoord3fv(GLfloat *); void glTexCoord3dv(GLdouble *);
void glTexCoord4f(GLfloat ,GLfloat ,GLfloat, GLfloat ); void glTexCoord4d(GLdouble ,GLdouble ,GLdouble, GLdouble ); void glTexCoord4fv(GLfloat *); void glTexCoord4dv(GLdouble *);
...
#define ST_TO_TEXTURE_BYTE_OFFSET(s,t) (ZB_POINT_T_FRAC_BITS == (ZB_POINT_S_FRAC_BITS + TGL_FEATURE_TEXTURE_POW2))?(( ((s & ZB_S_MASK) | (t & ZB_T_MASK)) >> (ZB_POINT_S_VALUE-PSZSH))):(( ((s & ZB_S_MASK)>>(ZB_POINT_S_VALUE-PSZSH)) | ((t & ZB_T_MASK)>>(ZB_POINT_T_VALUE-PSZSH))  ))
